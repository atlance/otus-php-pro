...
final class Assert
{
    ...
    public static function stringOfLength(int $length, string $value, ?string $message = null): void
    {
    ...
    public static function notEmptyString(mixed $value, ?string $message = null): void
    {
        Not\NotEmptyString::assert($value, $message);
    }
}
