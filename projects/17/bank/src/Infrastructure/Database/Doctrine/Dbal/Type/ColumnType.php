...
final class ColumnType
{
    ...
    final public const BANK_CARD_NUMBER = BankCard\NumberType::NAME;
    final public const BANK_CARD_EXPIRY = BankCard\ExpiryType::NAME;
    final public const BANK_CARD_CVV = BankCard\CvvType::NAME;
    final public const BANK_CARD_HOLDER = BankCard\HolderType::NAME;
}
