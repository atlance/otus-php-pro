...
final class SimpleCacheBridge implements CacheInterface
{
    private AbstractAdapter $cacheItemPool;
    ...
    {
        return $this->cacheItemPool->clear($prefix);
    }
    ...
    private function wrapException(\Throwable $e): InvalidArgumentException
    {
        return new InvalidArgumentException($e->getMessage(), (int) $e->getCode(), $e);
    }
}
